...
public class CreditsScreen extends BScreen {
	
private Table tabla;
SpriteBatch sb;
Texture bgImg;

public CreditsScreen(Demo game) {
	super(game);
	
	//initialize();
	sb = new SpriteBatch();
	bgImg = new Texture(Gdx.files.internal("maps/images/CreditScreen.png"));
	tabla = new Table();
	tabla.setFillParent(true);
	tabla.setPosition(-550, 330);
	this.uiStage.addActor(tabla);
	
	TextButton backBtn = new TextButton("Atrás", ResourceManager.textButtonStyle);
	backBtn.addListener(
