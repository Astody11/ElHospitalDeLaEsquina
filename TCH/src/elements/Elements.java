...
public class Elements extends Actor{
	...
	public Elements(float x, float y, Stage s) {
	...
	public Elements(float x, float y, Stage s, float w, float h) {
		this.setPosition(x, y);
		s.addActor(this);
		   velocity = new Vector2(0,0);
	        acceleration = new Vector2(0,0);
	...
	public boolean overlaps(Elements elemento)
	    {
	  ...
	  public Vector2 preventOverlap(Elements other)
	    {
	        Polygon poly1 = this.getBoundaryPolygon();
